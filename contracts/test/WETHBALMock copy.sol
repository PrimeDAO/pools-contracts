    ...
    PoolPriceOracle
{
        ...
        TemporarilyPausable(params.pauseWindowDuration, params.bufferPeriodDuration)
    {
        ...
        uint256 normalizedSum = 1;//params.normalizedWeight0.add(params.normalizedWeight1);
    ...
    function getInvariant() public view returns (uint256) {
        ...
        return 1;//WeightedMath._calculateInvariant(normalizedWeights, balances);
    }
        ...
        )
    {
        ...
        uint256 invariantBeforeJoin = 1;//WeightedMath._calculateInvariant(normalizedWeights, balances);
    ...
    function _getDueProtocolFeeAmounts(
        ...
        dueProtocolFeeAmounts[_maxWeightTokenIndex] = 1;
    ...
    function getRate() public view returns (uint256) {
        ...
        return 1;//Math.mul(getInvariant(), 2).divDown(totalSupply());
    }
